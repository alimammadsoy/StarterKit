...
namespace StarterKit.Persistence.Migrations
{
    ...
    [Migration("20251210061453_PasswordResetsTableAdded")]
    partial class PasswordResetsTableAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarterKit.Domain.Entities.Identity.PasswordReset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StarterKit.Domain.Entities.Identity.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("StarterKit.Domain.Entities.Identity.PasswordReset", b =>
                {
                    b.HasOne("StarterKit.Domain.Entities.Identity.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
